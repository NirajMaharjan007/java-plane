...
public class EnemyInvertMove implements ApplicationListener {
    ...
    public EnemyInvertMove(Vector2 position, SpriteBatch spriteBatch) {
    ...
    public void create() {
        ...
        walkSheet = new Texture(Gdx.files.internal("./image/enemy/enemy_plane_invert.png"));
