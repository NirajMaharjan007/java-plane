...
public class PlayerMove implements ApplicationListener {
    ...
    public PlayerMove(Vector2 position, SpriteBatch spriteBatch) {
    ...
    public void create() {
        ...
        walkSheet = new Texture(Gdx.files.internal("./image/player/plane_move.png"));
